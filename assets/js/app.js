...
function designApp() {
    return {
        ...
        init() {
           ...
           const stickyDiv = document.querySelector('#stickyTop');
           console.log(stickyDiv.offsetTop)
           this.comDivPos = stickyDiv.offsetTop;
            this.designTab = true;
            // console.log(firstDiv.offsetTop);
        },
        fixTop(){
        this.atTop = (window.pageYOffset > this.comDivPos -50) ? false : true
    },
        headerScroll() {
